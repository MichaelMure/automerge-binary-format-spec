...
| key counter | 19 | 1 | <<Delta Column>> | counter of the operation ID of the key of each
  operation
...
| predecessor group | 112 | 7 |<<Group Column>> | The group for the predecessors of this operation (only in <<change-chunks,change chunks>>)
| predecessor actor IDs |113 | 7 | Grouped <<Actor Column>> | The actor ID of each predecessor's operation ID
| predecessor counters |115 | 7 | Grouped <<Delta Column>> | The counter of each predecessor's operation ID
...
| rich-text: expand control | 148 | 9 | <<Boolean Column>> | How the mark expands on the text
| rich-text: mark | 165 | 10 | <<String Column>> | The name of the formatting mark
|===
